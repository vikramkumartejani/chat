                    ...
                    <div className='bg-bg_color_100 rounded-full flex items-center gap-3 p-2 relative'>
                        ...
                        <div className={`flex items-center gap-3 ${isVoiceOn ? 'hidden' : ''}`}>
                            <button className='relative flex items-center justify-end self-end overflow-hidden' onClick={handleButtonClick}>
                                <svg stroke="" fill="text-custom_color_800" stroke-width="0" viewBox="0 0 24 24" aria-hidden="true" class="h-5 w-5 lg:h-6 lg:w-6" height="1em" width="1em">
                        ...
                        <div className={`flex items-center gap-3 ${!isVoiceOn ? 'hidden' : ''}`}>
                            <button className='relative flex items-center justify-end self-end overflow-hidden' onClick={handleButtonClick}>
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" aria-hidden="true" class="h-5 w-5 text-primary-700 lg:h-6 lg:w-6" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div >
                            <h3 onClick={toggleDropdown}>
                                <svg
                                    ...
                                    viewBox="0 0 20 20"
                                    aria-hidden="true"
                                    className="h-5 w-5 lg:h-6 lg:w-6 inline-block"
                                    height="1em"
                                    width="1em"
                                >
                                    <path
